...
```sh
gh release download --repo kjanat/actionlint --pattern '*_linux_amd64.tar.gz' v1.15.1
tar xf actionlint_1.15.1_linux_amd64.tar.gz
./actionlint -version
```
...
```sh
gh attestation verify -R kjanat/actionlint actionlint_1.15.1_linux_amd64.tar.gz
```
