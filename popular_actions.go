...
var PopularActions = map[string]*ActionMetadata{
	...
	"actions/setup-java@v6": {
		...
		Inputs: ActionMetadataInputs{
			...
			"cache":                               {"cache", false, false, ""},
			"cache-dependency-path":               {"cache-dependency-path", false, false, ""},
			"cache-jdk":                           {"cache-jdk", false, false, ""},
			"cache-path":                          {"cache-path", false, false, ""},
			"cache-read-only":                     {"cache-read-only", false, false, ""},
			"check-latest":                        {"check-latest", false, false, ""},
			"distribution":                        {"distribution", false, false, ""},
			"force-download":                      {"force-download", false, false, ""},
			"gpg-passphrase":                      {"gpg-passphrase", false, false, ""},
			"gpg-passphrase-env-var":              {"gpg-passphrase-env-var", false, false, ""},
			"gpg-private-key":                     {"gpg-private-key", false, false, ""},
			"java-package":                        {"java-package", false, false, ""},
			"java-version":                        {"java-version", false, false, ""},
			"java-version-file":                   {"java-version-file", false, false, ""},
			...
			"jdkfile":                             {"jdkFile", false, true, "The `jdkFile` input is deprecated. Use `jdk-file` instead."},
			"job-status":                          {"job-status", false, false, ""},
			"mvn-repositories":                    {"mvn-repositories", false, false, ""},
			"mvn-repositories-include-central":    {"mvn-repositories-include-central", false, false, ""},
			"mvn-repositories-prioritize-central": {"mvn-repositories-prioritize-central", false, false, ""},
			"mvn-server-credentials":              {"mvn-server-credentials", false, false, ""},
			"mvn-toolchain-id":                    {"mvn-toolchain-id", false, false, ""},
			"mvn-toolchain-vendor":                {"mvn-toolchain-vendor", false, false, ""},
			"overwrite-settings":                  {"overwrite-settings", false, false, ""},
			"problem-matcher":                     {"problem-matcher", false, false, ""},
			"server-id":                           {"server-id", false, false, ""},
			"server-password":                     {"server-password", false, false, ""},
			"server-password-env-var":             {"server-password-env-var", false, false, ""},
			"server-username":                     {"server-username", false, false, ""},
			"server-username-env-var":             {"server-username-env-var", false, false, ""},
			"set-default":                         {"set-default", false, false, ""},
			"settings-path":                       {"settings-path", false, false, ""},
			"show-download-progress":              {"show-download-progress", false, false, ""},
			"token":                               {"token", false, false, ""},
	...
	"game-ci/unity-builder@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"dockershmsize":                 {"dockerShmSize", false, false, ""},
	...
	"kjanat/actionlint@v1": {
		Name: "actionlint by @kjanat",
		Inputs: ActionMetadataInputs{
			"config-file":       {"config-file", false, false, ""},
			"fail-on-error":     {"fail-on-error", false, false, ""},
			"files":             {"files", false, false, ""},
			"format":            {"format", false, false, ""},
			"ignore":            {"ignore", false, false, ""},
			"output-file":       {"output-file", false, false, ""},
			"pyflakes":          {"pyflakes", false, false, ""},
			"shellcheck":        {"shellcheck", false, false, ""},
			"working-directory": {"working-directory", false, false, ""},
		},
		Outputs: ActionMetadataOutputs{
			"exit-code":      {"exit-code"},
