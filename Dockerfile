...
ENV CGO_ENABLED=0
ARG ACTIONLINT_VER=
RUN go build -v -ldflags "-s -w -X actionlint.kjanat.dev.version=${ACTIONLINT_VER} -X 'actionlint.kjanat.dev.installedFrom=official Docker image'" -o . ./cmd/actionlint ./cmd/actionlint-action
