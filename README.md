...
**This fork 1.15.1 reports 3: `expression`, `require-commit-hash`, `parallel-steps`**
...
The moving `v1` tag follows compatible v1 releases, and `v1.15` follows v1.15 patch releases. These tags point to a
commit immediately after the release that pins the published container image by digest. `v1.15.1` is a versioned release tag.
...
[checks]: https://github.com/kjanat/actionlint/blob/v1.15.1/docs/checks.md
[install]: https://github.com/kjanat/actionlint/blob/master/docs/install.md
[usage]: https://github.com/kjanat/actionlint/blob/v1.15.1/docs/usage.md
[config]: https://github.com/kjanat/actionlint/blob/v1.15.1/docs/config.md
[api]: https://github.com/kjanat/actionlint/blob/v1.15.1/docs/api.md
[refs]: https://github.com/kjanat/actionlint/blob/v1.15.1/docs/reference.md
